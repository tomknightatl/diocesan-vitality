...
class ParishDeduplicator:
    ...
    def are_parishes_duplicate(self, parish1, parish2) -> Tuple[bool, dict]:
        ...
        addr1 = getattr(parish1, 'street_address', None) or getattr(parish1, 'full_address', None) or getattr(parish1, 'address', None)
        addr2 = getattr(parish2, 'street_address', None) or getattr(parish2, 'full_address', None) or getattr(parish2, 'address', None)
    ...
    def _merge_parish_info(self, primary_parish, duplicate_parish):
        ...
        fields_to_merge = ['phone', 'website', 'street_address', 'full_address', 
