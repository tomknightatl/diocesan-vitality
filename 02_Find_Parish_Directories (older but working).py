...
# <a href="https://colab.research.google.com/github/tomknightatl/USCCB/blob/main/notebooks/02_Find_Parish_Directories%20(older%20but%20working).ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
...
#  # Moved to User-configurable parameters cell
...
SUPABASE_URL_FROM_USERDATA = os.getenv('SUPABASE_URL')
SUPABASE_KEY_FROM_USERDATA = os.getenv('SUPABASE_KEY')
