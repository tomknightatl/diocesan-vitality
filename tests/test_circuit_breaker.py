...
import time
import random
from core.circuit_breaker import circuit_breaker, CircuitBreakerConfig, CircuitBreakerOpenError, circuit_manager
...
@circuit_breaker('test_service_unreliable', CircuitBreakerConfig(
    failure_threshold=3,
    recovery_timeout=5,
    request_timeout=2,
    max_retries=1,
...
@circuit_breaker('test_service_timeout', CircuitBreakerConfig(
    failure_threshold=2,
    recovery_timeout=3,
    request_timeout=1,
    max_retries=0
...
@circuit_breaker('test_service_reliable', CircuitBreakerConfig(
    failure_threshold=5,
    recovery_timeout=10,
    request_timeout=5,
    max_retries=2
