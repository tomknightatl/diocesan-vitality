...
def _parse_command_line_arguments():
    ...
    parser.add_argument(
        ...
        type=int,
        default=config.DEFAULT_MAX_PARISHES_PER_DIOCESE,
    ...
    parser.add_argument(
        ...
        help="Max dioceses to process in Steps 1 and 3. Set to 0 for no limit.",
    )
    parser.add_argument(
...
def _run_diocese_extraction_step(args, monitoring_client):
    ...
    try:
        ...
        monitoring_client.update_extraction_status(status="running", current_diocese="Official Website", parishes_processed=0)
